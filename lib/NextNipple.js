...
/**
 * A next wrapper component for `nipplejs`.
 * @see https://www.npmjs.com/package/nipplejs
 * @author Jovica Aleksic <jovica.aleksic@loopmode.de>
 */
var NextNipple = (_class = function (_Component) {
    _inherits(NextNipple, _Component);

    function NextNipple() {
        _classCallCheck(this, NextNipple);

        return _possibleConstructorReturn(this, (NextNipple.__proto__ || Object.getPrototypeOf(NextNipple)).apply(this, arguments));
    }

    _createClass(NextNipple, [{
        ...
        value: function render() {
            return _react2.default.createElement('div', _extends({}, this.elementProps, { ref: this.handleElement, className: (0, _classnames2.default)('NextNipple', this.props.className) }));
        }
